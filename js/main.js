...
function goToLanding() {
    ...
    window.history.pushState({}, '', window.location.pathname + (lang ? `?lang=${lang}` : ''));
    showPage('landing');
}
...
function updatePageText() {
    // Landing page
    document.querySelector('#landing-page h1').textContent = `🎅 ${t('landing.title')}`;
    document.querySelector('#landing-page p').textContent = t('landing.subtitle');
    document.querySelector('#landing-page article header strong').textContent = t('landing.howItWorks');
    ...
    document.querySelector('label[for="participants"]').childNodes[0].textContent = t('create.participantsLabel') + ' ';
    document.querySelector('label[for="participants"] small').textContent = t('create.participantsHelp');
    document.getElementById('participants').placeholder = t('create.participantsPlaceholder');
    document.querySelector('label[for="seed"]').childNodes[0].textContent = t('create.seedLabel') + ' ';
    document.querySelector('label[for="seed"] small').textContent = t('create.seedHelp');
    document.getElementById('seed').placeholder = t('create.seedPlaceholder');
    document.querySelector('label[for="admin-password"]').childNodes[0].textContent = t('create.passwordLabel') + ' ';
    document.querySelector('label[for="admin-password"] small').textContent = t('create.passwordHelp');
    document.getElementById('admin-password').placeholder = t('create.passwordPlaceholder');
    document.getElementById('back-to-landing').textContent = t('create.backButton');
    document.querySelector('#create-form button[type="submit"]').textContent = t('create.submitButton');
    ...
    document.querySelector('#view-participant-page h1').textContent = t('viewParticipant.title');
    document.querySelector('#view-participant-page p').textContent = t('viewParticipant.youAre');
    document.querySelector('#view-participant-page footer small').textContent = t('viewParticipant.keepSecret');
    document.getElementById('back-from-view').textContent = t('viewParticipant.backButton');
    ...
    document.querySelector('#all-assignments article header strong').textContent = t('viewAdmin.allAssignmentsTitle');
    document.querySelector('#assignments-table').closest('table').querySelector('th:nth-child(1)').textContent = t('viewAdmin.giverColumn');
    document.querySelector('#assignments-table').closest('table').querySelector('th:nth-child(3)').textContent = t('viewAdmin.receiverColumn');
    document.getElementById('back-from-admin').textContent = t('viewAdmin.backButton');

    // Error page
    document.querySelector('#error-page article header strong').textContent = t('error.title');
    document.getElementById('back-from-error').textContent = t('error.backButton');
}
