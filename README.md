...
Every pull request targeting the `main` branch automatically runs:

- **oxlint**: Fast JavaScript linter ensuring code follows best practices
- **oxfmt**: Fast code formatter checking formatting consistency
- **i18n Validation**: Verifies all locale JSON files comply with the schema

The PR checks must pass before merging to ensure code quality.
